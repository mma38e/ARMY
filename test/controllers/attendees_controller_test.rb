...
class AttendeesControllerTest < ActionController::TestCase
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post :create, attendee: { attending: @attendee.attending, event_id: @attendee.event_id, membership_id: @attendee.membership_id }
    end
  ...
  test "should update attendee" do
    patch :update, id: @attendee, attendee: { attending: @attendee.attending, event_id: @attendee.event_id, membership_id: @attendee.membership_id }
    assert_redirected_to attendee_path(assigns(:attendee))
  end
