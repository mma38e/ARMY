...
class MembershipsControllerTest < ActionController::TestCase
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post :create, membership: { approved: @membership.approved, club_id: @membership.club_id, user_id: @membership.user_id }
    end
  ...
  test "should update membership" do
    patch :update, id: @membership, membership: { approved: @membership.approved, club_id: @membership.club_id, user_id: @membership.user_id }
    assert_redirected_to membership_path(assigns(:membership))
  end
